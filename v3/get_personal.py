...
def personal(match, frame, skill_df):
    summary_columns = ['gameID', 'participantID', 'teamID', 'win', 'summonerName', 'role', 'champion', 'level', 
                       'kills', 'deaths', 'assists', 'spell1', 'spell2', 'item0', 'item1', 'item2', 'item3', 'item4', 'item5', 'item6', 
                       'goldEarned', 'goldSpent', 'skillTree']
    rune_columns = ['gameID', 'participantID', 'primaryRune', 'primaryRune0', 'primaryRune1', 'primaryRune2', 'primaryRune3',
                    'subRune', 'subRune0', 'subRune1', 'statRune0', 'statRune1', 'statRune2']
    detail_columns = ['gameID', 'participantID', 'sDamageDealt', 'mDamageDealt', 'pDamageDealt', 'tDamageDealt', 'sDamageTaken',
                      ...
                      'minionCS', 'jungleCS', 'teamJungleCS', 'enemyJungleCS', 'visionScore', 'visionWardsBought', 
    ...
    team_win_dict = {team['teamId'][0]:win_dict[team['win'][0]], team['teamId'][1]:win_dict[team['win'][1]]}
    ...
    for i in range(len(participants)):
        ...
        summary_df.loc[participantId-1, 'win'] = team_win_dict[participants.iloc[i]['teamId']]
    ...
    rename_list = {'totalDamageDealtToChampions':'sDamageDealt', 'magicDamageDealtToChampions':'mDamageDealt',
                   ...
                   'totalMinionsKilled':'minionCS', 'neutralMinionsKilled':'jungleCS', 
                   'neutralMinionsKilledTeamJungle':'teamJungleCS', 'neutralMinionsKilledEnemyJungle': 'enemyJungleCS',
                   'visionWardsBoughtInGame':'visionWardsBought', 'champLevel': 'level', 
                   'perkPrimaryStyle': 'primaryRune' , 'perk0': 'primaryRune0', 'perk1': 'primaryRune1', 'perk2': 'primaryRune2', 
                   'perk3': 'primaryRune3', 'perkSubStyle': 'subRune', 'perk4': 'subRune0', 'perk5': 'subRune1', 
    ...
    for_summary_list = ['level', 'item0', 'item1', 'item2', 'item3', 'item4', 'item5', 'item6', 
                        'kills', 'deaths', 'assists', 'goldEarned', 'goldSpent']
    for_rune_list = ['primaryRune', 'primaryRune0', 'primaryRune1', 'primaryRune2', 'primaryRune3', 'subRune', 
    ...
    for_detail_list = ['sDamageDealt', 'mDamageDealt', 'pDamageDealt', 'tDamageDealt', 'sDamageTaken', 'mDamageTaken', 
                       ...
                       'jungleCS', 'teamJungleCS', 'enemyJungleCS', 'visionScore', 'visionWardsBought', 'wardsPlaced', 'wardsKilled',
    ...
    for i in range(len(skill_df)):
        if skill_df['levelupType'][i] != 'NORMAL':
            continue
        skillTree_list[skill_df['participantID'][i]-1] += slot_dict[skill_df['skillSlot'][i]]

    summary_df.loc[:,'skillTree'] = skillTree_list
